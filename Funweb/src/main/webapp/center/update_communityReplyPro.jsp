...
<body>
	...
	try{
		if(request.getParameter("update_reply") != null || !request.getParameter("update_reply").equals("")){
			...
			int updateReplyCount = communityReplyDAO.updateReply(num, re_reply);
			
			if(updateReplyCount > 0){
				
				response.sendRedirect("./update_communityReply.jsp?num="+ num + "&root_num=" + root_num + "&page=" + pageNum + "&count=" + updateReplyCount + "&id=" + id);
