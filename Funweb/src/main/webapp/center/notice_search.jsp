		...
		<article>
			...
			<table id="notice">
				...
				BoardDAO boardDAO = new BoardDAO();
						...
						int listCount = boardDAO.getListSearchCount(search,searchOption);
						int listLimit = 3;
						int pageLimit = 10;
						...
						ArrayList<BoardDTO> list = boardDAO.searchBoardList(pageNum, listLimit, search, searchOption);
			...
			<div id="page_control">
				...
				<%} else { %>
					...
					<a href="./notice_search.jsp?page=<%=pageNum - 1 %>&search=<%=search%>&searchOption=<%=searchOption%>">이전페이지</a>
				...
				<% for(int i = startPage; i <= endPage; i++){
					   ...
					   <%} else {%>
						   ...
						   <a href="./notice_search.jsp?page=<%=i %>&search=<%=search%>&searchOption=<%=searchOption%>"><%=i %></a>
				...
				<%} else { %>
					...
					<a href="./notice_search.jsp?page=<%=pageNum + 1  %>&search=<%=search%>&searchOption=<%=searchOption%>">다음페이지</a>
