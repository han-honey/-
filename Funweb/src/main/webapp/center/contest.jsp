...
<head>
<meta charset="UTF-8">
<title>center/cooking_contest.jsp</title>
	...
	<div id="wrap">
		...
		<article>
			...
			<table id="notice">
				...
				int listCount = contestDAO.getListCount();
				int listLimit = 3;
				int pageLimit = 10;
				...
				ArrayList<ContestDTO> list = contestDAO.selectContestList(pageNum, listLimit);
			...
			<div id="page_control">
				...
				<a href="./contest.jsp?page=<%=pageNum - 1 %>">Prev</a>
				...
				<a href="./contest.jsp?page=<%=pageNum + 1  %>">Next</a>
