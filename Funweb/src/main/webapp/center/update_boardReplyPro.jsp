...
<body>
	...
	try{
		if(request.getParameter("update_reply") != null || !request.getParameter("update_reply").equals("")){
			...
			int updateReplyCount = boardReplyDAO.updateReply(num, re_reply);
			
			if(updateReplyCount > 0){
				
				response.sendRedirect("./update_boardReply.jsp?num="+ num + "&root_num=" + root_num + "&page=" + pageNum + "&count=" + updateReplyCount + "&id=" + id);
